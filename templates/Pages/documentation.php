...
<section id="advice">
  ...
  <ul>
    ...
    <li><b>Go through the pages that are bundled with the CakephpLteTheme.</b> Most of the template example pages contain quick tips on how to create or use a component which can be really helpful when you need to create something on the fly.</li>
