              ...
              <div class="card-body pad table-responsive">
                ...
                <table class="table table-bordered text-center">
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-outline-primary btn-flat">Primary</button>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-outline-secondary btn-flat">Secondary</button>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-outline-success btn-flat">Success</button>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-outline-info btn-flat">Info</button>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-outline-danger btn-flat">Danger</button>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-outline-warning btn-flat">Warning</button>
                    </td>
                    <td>
              ...
              <div class="card-body pad table-responsive">
                ...
                <table class="table table-bordered text-center">
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn bg-gradient-primary btn-lg">Primary</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-primary btn-sm">Primary</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-primary btn-xs">Primary</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-primary btn-flat">Primary</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-primary disabled">Primary</button>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <button type="button" class="btn bg-gradient-secondary btn-lg">Secondary</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-secondary btn-sm">Secondary</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-secondary btn-xs">Secondary</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-secondary btn-flat">Secondary</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-secondary disabled">Secondary</button>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <button type="button" class="btn bg-gradient-success btn-lg">Success</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-success btn-sm">Success</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-success btn-xs">Success</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-success btn-flat">Success</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-success disabled">Success</button>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <button type="button" class="btn bg-gradient-info btn-lg">Info</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-info btn-sm">Info</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-info btn-xs">Info</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-info btn-flat">Info</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-info disabled">Info</button>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <button type="button" class="btn bg-gradient-danger btn-lg">Danger</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-danger btn-sm">Danger</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-danger btn-xs">Danger</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-danger btn-flat">Danger</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-danger disabled">Danger</button>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <button type="button" class="btn bg-gradient-warning btn-lg">Warning</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-warning btn-sm">Warning</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-warning btn-xs">Warning</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-warning btn-flat">Warning</button>
                    </td>
                    <td>
                      <button type="button" class="btn bg-gradient-warning disabled">Warning</button>
                    </td>
                  </tr>
                </table>
              </div>
          ...
          <div class="col-md-6">
            ...
            <div class="card">
              ...
              <div class="card-body row">
                <div class="col-md-6">
                  ...
                  <button type="button" class="btn btn-info btn-flat"><i class="fa fa-bell"></i> ..btn-flat</button>
                  <button type="button" class="btn btn-danger btn-sm"><i class="fa fa-bell"></i> ..btn-sm</button>
                </div>
                <div class="col-md-6">
                  <button type="button" class="btn btn-outline-primary btn-block"><i class="fa fa-bell"></i> .btn-block</button>
                  <button type="button" class="btn btn-outline-info btn-flat"><i class="fa fa-book"></i> ..btn-flat</button>
                  <button type="button" class="btn btn-outline-danger btn-sm"><i class="fa fa-book"></i> ..btn-sm</button>
                </div>
              </div>
            </div>
            <!-- /.card -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-default btn-flat">..btn-flat</button>
